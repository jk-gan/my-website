  ...
  return (
    <div className="flex items-center justify-center h-screen container mx-auto px-5">
      <div>
        ...
        <p className="text-left font-medium text-2xl text-gray-500 mb-1">Building the World's Most Advanced Education Platform at <a href="https://www.mindvalley.com">Mindvalley</a>.</p>
